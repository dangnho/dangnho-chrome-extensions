...
var getUrlParameter = function getUrlParameter(t) {
  for (var o, e = window.location.search.substring(1).split("&"), n = 0; n < e.length; n++) {
    if ((o = e[n].split("="))[0] === t) return void 0 === o[1] || decodeURIComponent(o[1]);
  }
};
...
function domain_from_url(t) {
  var o;
  return (t = t.match(/^(?:https?:\/\/)?(?:[^@\n]+@)?(?:www\.)?([^:\/\n\?\=]+)/im)) && (t = (o = t[1]).match(/^[^\.]+\.(.+\..+)$/)) && (o = t[1]), o;
}
