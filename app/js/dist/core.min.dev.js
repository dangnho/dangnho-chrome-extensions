...
var getUrlParameter = function getUrlParameter(t) {
  for (var e, o = window.location.search.substring(1).split("&"), n = 0; n < o.length; n++) {
    if ((e = o[n].split("="))[0] === t) return void 0 === e[1] || decodeURIComponent(e[1]);
  }
};

function extractHostname(t) {
  var e = -1 < t.indexOf("//") ? t.split("/")[2] : t.split("/")[0];
  return e = (e = e.split(":")[0]).split("?")[0];
}

function domain_from_url(t) {
  var e, o;
  return (o = t.match(/^(?:https?:\/\/)?(?:[^@\n]+@)?(?:www\.)?([^:\/\n\?\=]+)/im)) && (o = (e = o[1]).match(/^[^\.]+\.(.+\..+)$/)) && (e = o[1]), e;
}
...
function fetchDangNho(t, e) {
  var o = '<a class="fetchpost" href="https://tapchidangnho.com/?key=' + t + "&t=" + e + '" style="background: #ff0; color: #000; display: inline-block; padding: 3px 12px; font-size: 15px; position: fixed; top: 15px; right: 15px; z-index: 10000; border-radius: 3px; font-weight: bold;">Fetch bài này</a>';
  jQuery("body").append(o);
}

function fetchDangNhoBook(t, e) {
  var o = '<a class="fetchpost" href="https://tapchidangnho.com/?key=' + t + "&t=" + e + '&book=true" style="background: #ff0; color: #000; display: inline-block; padding: 3px 12px; font-size: 15px; position: fixed; top: 15px; right: 15px; z-index: 10000; border-radius: 3px; font-weight: bold;">Fetch bài này</a>';
  jQuery("body").append(o);
}
...
}), "dangnho.com" !== APP_HOST || "/admin/post-new.php" !== APP_PATH && "/admin/post.php" !== APP_PATH || jQuery(document).ready(function () {
